...
write.csv(flags, file=file.path(out_dir,"outlier_flags.csv"), row.names=FALSE)
write.csv(summary_tab, file=file.path(out_dir,"outlier_summary.csv"), row.names=FALSE)
write.csv(train_wins, file=file.path(out_dir,"train_winsorized.csv"), row.names=FALSE)
write.csv(train_clean, file=file.path(out_dir,"train_clean_removed_outliers.csv"), row.names=FALSE)
